...
class Sidebar {
  ...
  constructor({ sidebar, resizer, toggleButton }, ltr, isResizerOnTheLeft) {
    ...
    // #modified by ngx-extended-pdf-viewer
    // Don't add click listener to toggleButton - ngx-extended-pdf-viewer handles this in Angular
    // to support custom toolbars and prevent duplicate event handlers that cancel each other out
